...
`simulate_trajectory_FR` does the same as above, but the individual is not restrained around its colony and does not perform homing bout. **Should add a condition on the time spent around a same area**. 
