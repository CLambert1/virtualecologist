...
The upcoming analyses necessitates working in a projected environment. Because we are in a virtual environment, we must define a custom projection. This is what does \code{\link{custom_proj()}}.
...
fusen::inflate(flat_file = "dev/flat_simulate_sp.Rmd", vignette_name = "Simulate virtual species")
```
